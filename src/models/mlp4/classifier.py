...
from src.models.mlp4.model import MLP4Model

class MLP4ClassifierModel(AbstractClassifier):
    def __init__(self, config):
        super(MLP4ClassifierModel, self).__init__()
        self.save_hyperparameters(config) 

        self.model = MLP4Model(
    ...
    def backward(self, *args, **kwargs):
        if hasattr(self.model, "backward"):
            ...
            return super(MLP4ClassifierModel, self).backward(*args, **kwargs)
