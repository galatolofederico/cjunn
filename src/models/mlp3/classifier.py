...
from src.models.mlp3.model import MLP3Model

class MLP3ClassifierModel(AbstractClassifier):
    def __init__(self, config):
        super(MLP3ClassifierModel, self).__init__()
        self.save_hyperparameters(config) 

        self.model = MLP3Model(
    ...
    def backward(self, *args, **kwargs):
        if hasattr(self.model, "backward"):
            ...
            return super(MLP3ClassifierModel, self).backward(*args, **kwargs)
